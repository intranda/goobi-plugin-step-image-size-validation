...
module.exports = (env, argv) => {
  return {
    entry: './main.js',
    output: {
        path: path.resolve(__dirname, 'resources/dist/intranda_step_image-size-validation/js/'),
    ...
    plugins: [
      argv.mode == 'development' ? new CopyPlugin({
        patterns: [
          { from: 'resources/dist/intranda_step_image-size-validation/js/',
            to: `${customLocation}dist/intranda_step_image-size-validation/js/`,
          },
        ]
      }) : false,
    ]
